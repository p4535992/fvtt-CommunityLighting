...
export class CLMonkeyPatcher {
    ...
    static runPatches() {
        ...
        // if (this.libWrapped) {
          //@ts-ignore
          libWrapper.register(CONSTANTS.MODULE_NAME, "Sound.prototype.play", wrappedSoundPlay, "WRAPPER");
          //@ts-ignore
          libWrapper.register(CONSTANTS.MODULE_NAME, "PointSource.prototype.animate", wrappedPointSourceAnimate, "WRAPPER");
        // } else {
